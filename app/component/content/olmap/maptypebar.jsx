		...
		return(
			<div id ="maptypebar" className="mapbar" onClick={this.handleMaptype}>
				...
				<div className="maptypebar-pane" style={{display:"none"}}>
					<div className="mapbar-ctl vec  unselected" data-type="vec">天地图</div>
					<div className="mapbar-ctl vec-label  unselected" data-type="vec-label">天地图标注</div>
					...
					<div className="mapbar-ctl baidumap  selected" data-type="baidumap">百度地图</div>
